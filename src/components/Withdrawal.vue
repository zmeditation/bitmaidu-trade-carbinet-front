    ...
    <div class="two-cols">
        <div class="onecol">
            ...
            <div class="form-row">
                ...
                <span class="text-muted">Your current balance is {{wallets[currency] ? wallets[currency].balance.toFixed(wallets[currency].precision) : 0}}. <span class="subaction" v-on:click="amount = wallets[currency].balance.toFixed(2)">Withdraw all</span></span>
            </div>
            <div class="form-row">
...
export default {
    ...
    computed: {
        ...mapGetters(['wallets', 'markets', 'currencies'])
    }
}
</script>
